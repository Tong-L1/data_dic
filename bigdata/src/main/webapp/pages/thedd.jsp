...
Dao dao = new Dao();
List<Thedd> list = dao.getAllThedd();
%>
<!DOCTYPE html>
<html>
                        ...
                        <div class="panel-body">
                            ...
                            <table style="width:100%;" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                for(int i=0;i<list.size();i++){
                                    out.print("<tr>"
                                    		+"<td>"+list.get(i).getTable_name()+"</td>"
                                            +"<td><input type='text' class='inputnob' value="+list.get(i).getColumn_name()+"></td>"
                                            +"<td><input type='text' class='inputnob' value="+list.get(i).getColumn_type()+"></td>"
                                            +"<td><input type='text' class='inputnob' value="+list.get(i).getColumn_key()+"></td>"
                                            +"<td><input type='text' class='inputnob' value="+list.get(i).getColumn_comment()+"></td>"      
                                            +"</tr>"); 
                                    }
                                %>
                                </tbody>
